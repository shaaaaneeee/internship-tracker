  ...
  return (
    <div className="mb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {/* Success rate */}
        <div>
          <p className="text-xs text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-6">Success rate</p>
      ...
      {funnelData.length > 1 && (
        <div>
          <p className="text-xs text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-6">Pipeline</p>
          <div className="h-32">
            <ResponsiveContainer width="100%" height="100%">
              <FunnelChart>
                <Tooltip
      ...
      {barData.length > 1 && (
        <div className="mt-10">
          <div className="border-t border-zinc-100 dark:border-zinc-800 mb-8" />
          <p className="text-xs text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-6">Applications per week</p>
          <div className="h-40">
            <ResponsiveContainer width="100%" height="100%">
